    ...
    [self moveX:-dist duration:0.15 finished:^{
        [self moveX:dist duration:0.15 finished:^{
            [self moveX:-(dist/2) duration:0.15 finished:^{
                [self moveX:dist/2 duration:0.05 finished:^{
                    if(finished)
                        finished();
                }];
            }];
...
-(void)shakeWithWidth:(CGFloat)width
{
    //float width = 2;
    [self moveX:-width*2 duration:0.1 finished:^{
        [self moveX:width*1.5 duration:0.1 finished:^{
            [self moveX:-(width) duration:0.1 finished:^{
                [self moveX:width/2.0 duration:0.1 finished:^{
                   [self moveX:width finished:^{
